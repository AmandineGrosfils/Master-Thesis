...
save_path = "cross-validation_folds_Diagonal1_Test/"
...
def is_diagonal(PAIR_12_CELL, entrie, doses1, doses2):
    ...
    if PAIR_12_CELL.iloc[entrie]["Conc1"]==doses1[0] and  PAIR_12_CELL.iloc[entrie]["Conc2"]==doses2[2]:
        diagonal = 1
    elif PAIR_12_CELL.iloc[entrie]["Conc1"]==doses1[1] and  PAIR_12_CELL.iloc[entrie]["Conc2"]==doses2[1]:
        diagonal = 1
    elif PAIR_12_CELL.iloc[entrie]["Conc1"]==doses1[2] and  PAIR_12_CELL.iloc[entrie]["Conc2"]==doses2[0]:
        diagonal = 1
    else:
        diagonal = 0
