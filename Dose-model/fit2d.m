function [fitresult, gof] = fit2d(ExpName,d1,d2,g12,name1,name2,f1,f2)
...
a_low=-0.9999;%calc_mina(d1,x0)+0.01;
b_low=-0.9999;%calc_mina(d2,y0)+0.01;
a_high=inf;
b_high=inf;
...
%saveas(f,[ExpName '/pdf/' savename '.pdf'],'pdf')
%print([ExpName '\emf\' savename ],'-dmeta')
%mprint([ExpName '/png/' savename],'-dpng','-r0');
